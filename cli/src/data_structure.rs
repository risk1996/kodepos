...
impl Data {
  pub fn into_models(&self) -> Vec<administrative_area::Model> {
    self
      .0
      .iter()
...
impl AdministrationLevel1 {
  pub fn into_model(&self, name: String) -> administrative_area::Model {
    administrative_area::Model {
      id: self.id.clone(),
      parent_id: None,
  ...
  pub fn into_models(&self, name: String) -> Vec<administrative_area::Model> {
...
impl AdministrationLevel2 {
  pub fn into_model(&self, name: String, parent_id: String) -> administrative_area::Model {
    administrative_area::Model {
      id: self.id.clone(),
  ...
  pub fn into_models(&self, name: String, parent_id: String) -> Vec<administrative_area::Model> {
